...
import { AlertController, Platform, IonSlides, MenuController} from '@ionic/angular';
...
verificar_si_el_eslash_despues_de_la_ruta_de_tabs_existe(){
  this.router.events.subscribe(
    ...
    if (event instanceof NavigationEnd) {
      var despuesde_eslash_indash = this.router.url.substring(0, this.router.url.lastIndexOf("/indash") + 1);
